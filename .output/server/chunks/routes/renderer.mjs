...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"Find the best restaurants near you"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[],"style":[],"script":[{"src":"https://maps.googleapis.com/maps/api/js?key=undefined&libraries=places","defer":true}],"noscript":[],"title":"Restaurant Finder"};
