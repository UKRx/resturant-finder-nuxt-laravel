...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Bj-hq46u.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BFDgkEA8.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B5z18nYn.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BONGndCf.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, nuxtLinkDefaults as c, defineStore as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useRuntimeConfig as u };
