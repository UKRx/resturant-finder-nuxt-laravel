import { _ as __nuxt_component_0 } from './nuxt-link-BeTPT8re.mjs';
...
import { u as useHead } from './v3-DXyTE1BL.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-xl font-bold text-primary-600"${_scopeId}> \u{1F37D}\uFE0F Restaurant Finder </h1>`);
          } else {
            return [
              createVNode("h1", { class: "text-xl font-bold text-primary-600" }, " \u{1F37D}\uFE0F Restaurant Finder ")
            ];
          }
        }),
        _: 1
      ...
      _push(`</main><footer class="bg-white border-t border-gray-200 mt-auto"><div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"><div class="text-center"><p class="text-gray-500 text-sm"> \xA9 2024 Restaurant Finder. Made with \u2764\uFE0F using Nuxt.js &amp; Laravel </p><p class="text-gray-400 text-xs mt-2"> Powered by Google Maps API </p></div></div></footer></div>`);
    };
  }
});
...
//# sourceMappingURL=default-BFDgkEA8.mjs.map
